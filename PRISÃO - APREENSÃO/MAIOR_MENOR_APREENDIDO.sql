/*----------------------------------------------------------------------------------------------------------------------
 * O código SQL a seguir está projetado para analisar dados de ocorrências e envolvimentos registrados, com o foco em prisões
 * efetuadas pela Polícia Militar de Minas Gerais. O código está estruturado 
 * para agrupar e contar o total de envolvidos por unidade operacional, baseando-se em diferentes 
 * faixas etárias (menor e maior idade).
 ----------------------------------------------------------------------------------------------------------------------*/
...
COUNT(ENV.numero_envolvido) qtde_envolvido,
    CASE 
...
GROUP BY 1, 2, 4, 5, 6, 7, 8, 3,10
ORDER BY 1, 2, 4, 5, 6, 7, 8, 3,10
