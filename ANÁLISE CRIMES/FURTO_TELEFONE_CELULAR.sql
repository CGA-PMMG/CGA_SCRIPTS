...
INNER JOIN db_bisp_reds_reporting.tb_material_apreendido_ocorrencia MAO ON OCO.numero_ocorrencia = MAO.numero_ocorrencia 
LEFT JOIN db_bisp_reds_master.tb_local_unidade_area_pmmg LO ON OCO.id_local = LO.id_local
WHERE 1 = 1 
 AND OCO.data_hora_fato BETWEEN '2025-05-01 00:00:00.000' AND '2025-05-18 23:59:59.000' -- FILTRA O ANO DO FATO
