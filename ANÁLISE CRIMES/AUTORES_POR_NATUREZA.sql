...
INNER JOIN db_bisp_reds_reporting.tb_envolvido_ocorrencia ENV ON ENV.numero_ocorrencia = OCO.numero_ocorrencia -- JUNÇÃO PARA ASSOCIAR ENVOLVIDOS ÀS OCORRÊNCIAS
INNER JOIN db_bisp_reds_reporting.tb_veiculo_ocorrencia VEI ON VEI.numero_ocorrencia = OCO.numero_ocorrencia -- JUNÇÃO PARA ASSOCIAR VEÍCULOS ÀS OCORRÊNCIAS
...
WHERE 1 = 1 
    ...
    AND VEI.tipo_veiculo_codigo = '0400'
