/*--------------------------------------------------------------------------------------------------------------------------------------------
 **************************************************** Reuniões Comunitárias (RC) *************************************************************

 * O indicador tem por objetivo aferir a participação da PMMG em reuniões comunitárias com a finalidade de orientar 
 * os cidadãos quanto à adoção de medidas de autoproteção, identificar e buscar soluções para problemas de segurança pública, e transmitir 
...
CASE WHEN OCO.codigo_municipio in (310690,311590,311960,312130,312738,312850,314020,314950,315010,315540,315620,316290) THEN '02 BPM'
        ...
        WHEN OCO.codigo_municipio =316620 AND (LO.unidade_area_militar_nome like '9 BPM%' or LO.unidade_area_militar_nome like '%/9 BPM%') THEN '09 BPM'
        ELSE 'OUTROS'
...
AND OCO.data_hora_fato BETWEEN BETWEEN '2025-01-01 00:00:00.000' AND '2025-08-05 23:59:59.000'  -- Filtra ocorrências por período específico (jan/2025 até ago/2025)
