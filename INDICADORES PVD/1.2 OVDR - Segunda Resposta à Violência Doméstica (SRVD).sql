/* ----------------------------------------------------------------------------------------------------------------------------------------------------
 *  ================================================================================================================================================
 *  ============================================== 1.2 OVDR -> SEGUNDA RESPOSTA À VIOLÊNCIA DOMÉSTICA ==============================================
 *  ================================================================================================================================================
 * 
 *  O item OVDR corresponde ao número de ocorrências de violência doméstica registradas na área da Unidade, denominador do indicador Segunda Resposta
 *  à Violência  Doméstica (SRVD) que tem por finalidade aferir o esforço das Unidades no que tange à abrangência de intervenção para 
 *  atendimento de segunda resposta.
 *-----------------------------------------------------------------------------------------------------------------------------------------------------*/
SELECT
   OCO.numero_ocorrencia,                                  -- Seleciona o número ocorrência
   UPPER(ENV.nome_completo_envolvido),					   -- Seleciona o nome completo do envolvido
...
WHERE 1 = 1
	...
	AND (	
	       ...
	       ) -- Fecha filtro de código de natureza 
