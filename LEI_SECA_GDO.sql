...
SELECT 	rat.numero_ocorrencia,  			-- Seleciona  número da ocorrência 
	...
	rat.relator_matricula,				-- Seleciona  matrícula do relator
	rat.relator_cargo,				-- Seleciona  cargo do relator
	rat.relator_nome,				-- Seleciona  nome do relator
	rat.digitador_matricula,			-- Seleciona  matrícula do digitador
