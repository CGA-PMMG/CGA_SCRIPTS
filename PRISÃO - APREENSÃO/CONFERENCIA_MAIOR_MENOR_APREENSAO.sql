...
SELECT  
    ...
    ENV.valor_idade_aparente,										-- Idade aparente do envolvido
...
CASE WHEN OCO.codigo_municipio IN (310690,311590,311960,312130,312738,312850,314020,314950,315010,315540,315620,316290) THEN '02 BPM'
 ...
 WHERE 1 = 1 
	...
	AND ENV.valor_idade_aparente BETWEEN 18 AND 30 -- Filtra faixa etária dentro do valor especificado
	...
	AND OCO.data_hora_fato BETWEEN '2025-05-01 00:00:00' AND '2025-05-10 00:00:00' -- Filtra data/hora fato dentro do intervalo especificado.
