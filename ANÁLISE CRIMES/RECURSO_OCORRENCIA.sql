...
VO.descricao_tipo_viatura, -- Seleciona a descrição do tipo da viatura
GROUP_CONCAT(DISTINCT GUA.numero_matricula) AS MATRICULA_INTEGRANTES_GUARNICAO, -- Seleciona o número de matricula dos militares vinculados a viatura
...
FROM db_bisp_reds_reporting.tb_ocorrencia OCO
 INNER JOIN db_bisp_reds_reporting.tb_viatura_ocorrencia VO on OCO.numero_ocorrencia = VO.numero_ocorrencia -- RETORNA OCORRÊNCIAS MESMO QUE NÃO TENHAM RECURSO RELACIONADO
 INNER JOIN db_bisp_reds_reporting.tb_integrante_guarnicao_ocorrencia GUA on GUA.numero_ocorrencia = VO.numero_ocorrencia AND GUA.numero_sequencial_viatura = VO.numero_sequencial_viatura-- RETORNA OCORRÊNCIAS MESMO QUE NÃO TENHAM RECURSO RELACIONADO
...
GROUP BY OCO.numero_ocorrencia, 
...
OCO.natureza_secundaria1_descricao, 
OCO.natureza_secundaria1_consumado , 
OCO.natureza_secundaria2_descricao,  
OCO.natureza_secundaria2_consumado, 
OCO.natureza_secundaria3_descricao, 
OCO.natureza_secundaria3_consumado, 
data_fato,
hora_fato,
RPM_2025,
UEOP_2025,
