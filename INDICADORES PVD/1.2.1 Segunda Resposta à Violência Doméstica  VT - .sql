...
CASE WHEN OCO.natureza_codigo = 'A20002'	THEN 'VT'	    	-- Se o código da natureza  A20002 retorna VT
...
WHERE 1 = 1
    ...
    AND OCO.natureza_codigo = 'A20002' -- Filtra as naturezas : Visitas tranquilizadoras (A20.002)
