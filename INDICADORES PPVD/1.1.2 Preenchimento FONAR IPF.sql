WITH ocorrencias_filtradas AS (
    SELECT  
        ...
        'Violencia Domestica' AS descricao_reds,
        'REDS' AS tipo_fonte,
        ...
        OCO.data_hora_fato AS data_hora_reds,
...
CASE WHEN OCO.codigo_municipio IN (310690,311590,311960,312130,312738,312850,314020,314950,315010,315540,315620,316290) THEN '02 BPM'
	...
	END AS UEOP_2025,       
        CASE 
            WHEN AVALIACAO.numero_ocorrencia IS NOT NULL AND AVALIACAO.id_avaliacao_risco_motivo IN (1, 2, 5) THEN 1
            ELSE 0
        END AS possui_avaliacao
    FROM db_bisp_reds_reporting.tb_ocorrencia AS OCO
    LEFT JOIN db_bisp_reds_reporting.tb_avaliacao_risco_vd AS AVALIACAO
        ON AVALIACAO.numero_ocorrencia = OCO.numero_ocorrencia
    WHERE 
        OCO.data_hora_fato >= '2025-01-01'
        AND OCO.ocorrencia_uf = 'MG'
        AND OCO.digitador_sigla_orgao = 'PM'
        AND OCO.nome_tipo_relatorio = 'POLICIAL'
        AND (
