/*----------------------------------------------------------------------------------------------------------------------------------------------
 ************************************************Visitas Tranquilizadoras (VT) - NUMERADOR ***************************************************

 * O indicador tem por objetivo aferir o número de visitas tranquilizadoras realizadas pelas Unidades e Frações às vítimas de furtos a 
 * residências e estabelecimentos, visando: orientar os cidadãos quanto à adoção de medidas de autoproteção; prevenir a revitimização; 
 * aumentar a sensação de segurança; e buscar informações sobre a prática criminosa de forma a aperfeiçoar o planejamento de ações e 
 * operações preventivas e repressivas.
 ----------------------------------------------------------------------------------------------------------------------------------------------*/
WITH 
FURTOS AS (                                            -- CTE que define ocorrências de furtos no período especificado
  ...
  WHERE oco.data_hora_fato BETWEEN '2025-01-01 00:00:00.000' AND '2025-04-30 23:59:59.000' -- Filtra ocorrências por período específico (todo o ano de 2024 até abril/2025)
...
OCO.pais_codigo
  ...
  WHERE OCO.data_hora_fato BETWEEN '2025-02-01 00:00:00.000' AND '2025-04-30 23:59:59.000'
    AND OCO.natureza_codigo IN ('A20000', 'A20028')
...
CASE
            WHEN VT.codigo_municipio IN (310620) THEN '01 RPM'
...
CASE WHEN VT.codigo_municipio in (310690,311590,311960,312130,312738,312850,314020,314950,315010,315540,315620,316290) THEN '02 BPM'
        ...
        WHEN VT.codigo_municipio =317020 AND (VT.unidade_area_militar_nome like '32 BPM%' or VT.unidade_area_militar_nome like '%/32 BPM%') THEN '32 BPM'
        WHEN VT.codigo_municipio =317020 AND (VT.unidade_area_militar_nome like '17 BPM%' or VT.unidade_area_militar_nome like '%/17 BPM%') THEN '17 BPM'
        WHEN VT.codigo_municipio =317010 AND (VT.unidade_area_militar_nome like '4 BPM%' or VT.unidade_area_militar_nome like '%/4 BPM%') THEN '04 BPM'
        WHEN VT.codigo_municipio =317010 AND (VT.unidade_area_militar_nome like '67 BPM%' or VT.unidade_area_militar_nome like '%/67 BPM%') THEN '67 BPM'
        WHEN VT.codigo_municipio =314330 AND (VT.unidade_area_militar_nome like '50 BPM%' or VT.unidade_area_militar_nome like '%/50 BPM%') THEN '50 BPM'
        WHEN VT.codigo_municipio =314330 AND (VT.unidade_area_militar_nome like '10 BPM%' or VT.unidade_area_militar_nome like '%/10 BPM%') THEN '10 BPM'
        WHEN VT.codigo_municipio =313670 AND (VT.unidade_area_militar_nome like '27 BPM%' or VT.unidade_area_militar_nome like '%/27 BPM%') THEN '27 BPM'
        WHEN VT.codigo_municipio =313670 AND (VT.unidade_area_militar_nome like '2 BPM%' or VT.unidade_area_militar_nome like '%/2 BPM%') THEN '02 BPM'
        WHEN VT.codigo_municipio =311860 AND (VT.unidade_area_militar_nome like '39 BPM%' or VT.unidade_area_militar_nome like '%/39 BPM%') THEN '39 BPM'
        WHEN VT.codigo_municipio =311860 AND (VT.unidade_area_militar_nome like '18 BPM%' or VT.unidade_area_militar_nome like '%/18 BPM%') THEN '18 BPM'
        WHEN VT.codigo_municipio =310670 AND (VT.unidade_area_militar_nome like '66 BPM%' or VT.unidade_area_militar_nome like '%/66 BPM%') THEN '66 BPM'
        WHEN VT.codigo_municipio =310670 AND (VT.unidade_area_militar_nome like '33 BPM%' or VT.unidade_area_militar_nome like '%/33 BPM%') THEN '33 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '1 BPM%' or VT.unidade_area_militar_nome like '%/1 BPM%') THEN '01 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '5 BPM%' or VT.unidade_area_militar_nome like '%/5 BPM%')  THEN '05 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '13 BPM%' or VT.unidade_area_militar_nome like '%/13 BPM%')  THEN '13 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '16 BPM%' or VT.unidade_area_militar_nome like '%/16 BPM%')  THEN '16 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '22 BPM%' or VT.unidade_area_militar_nome like '%/22 BPM%' )  THEN '22 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '41 BPM%' or VT.unidade_area_militar_nome like '%/41 BPM%') THEN '41 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '49 BPM%' or VT.unidade_area_militar_nome like '%/49 BPM%') THEN '49 BPM'
        WHEN VT.codigo_municipio =310620 AND (VT.unidade_area_militar_nome like '34 BPM%' or VT.unidade_area_militar_nome like '%/34 BPM%') THEN '34 BPM'
        ...
        WHEN VT.codigo_municipio =316620 AND (VT.unidade_area_militar_nome like '9 BPM%' or VT.unidade_area_militar_nome like '%/9 BPM%') THEN '09 BPM'
        ELSE 'OUTROS'
