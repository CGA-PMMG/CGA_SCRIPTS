/* -----------------------------------------------------------------------------------------------------------------------------------------------------
 * =====================================================================================================================================================
 * ============================================================ 1.1.3 REDS NATUREZA U33004 =============================================================
 * =====================================================================================================================================================
 * 
 * Item 3 do Atendimento de Primeira Resposta (APR) que tem por finalidade avaliar a proporção de atendimentos realizados pela Polícia Militar
 * das chamadas de serviço relacionadas às naturezas de violência doméstica.
 * O item 3 inclui todas as ocorrências de natureza 33.004 (principal ou secundária), geradas diretamente pelo militar no REDS ou sem classificação 
 * pelo Despachante do CAD.
 -----------------------------------------------------------------------------------------------------------------------------------------------------*/
SELECT
...
WHERE 1 = 1
    ...
    AND OCO.nome_tipo_relatorio = 'POLICIAL'  -- Seleciona tipos de relatório “POLICIAL” 
--    AND (ENV.codigo_sexo = 'F'  OR ENV.identidade_genero_codigo IN ('0400','0200','0700','0100','0600'))  --Inclui somente envolvidas do sexo feminino Ou com outras identidades de gênero especificadas
