/*-------------------------------------------------------------------------------------------------------------------
O objetivo deste código SQL é extrair informações sobre os efetivos empenhado no RAT. Incluindo o número da ocorrência, matrícula, nome, cargo do digitador, e  unidade responsável.
--------------------------------------------------------------------------------------------------------------------*/
            SELECT	
