...
SELECT DISTINCT
    ...
    VEI.tipo_veiculo_codigo, -- Seleciona o código do tipo de veículo
    VEI.tipo_veiculo_descricao, -- Seleciona a descrição do tipo de veículo
...
WHERE 1 = 1 
    ...
    AND ENV.envolvimento_codigo IN ('0100', '0200') -- Filtra o código do envolvimento, autor e co-autor
    ...
    AND OCO.natureza_codigo IN('C01155','C01156','C01157') -- Filtra o código da natureza, sendo, Furto, Furto de coisa comum e roubo
