/*----------------------------------------------------------------------------------------------------------------------
 * BUSCA PELO MARCADOR PADRONIZADO DE INDIVIDUO EM SITUAÇÃO DE RUA 
 * O código SQL a seguir está projetado para analisar dados de ocorrências e envolvimentos registrados, especificamente 
 * para o ano de 2025, com o foco indivíduos em situação de rua.
 * 
 * Atentar que a coluna entrou em produção no REDS / BISP em 01 de fevereiro de 2025, de maneira que em qualquer ocorrencia anterior terá valor NULL
 ----------------------------------------------------------------------------------------------------------------------*/
-- SELECIONA A UNIDADE OPERACIONAL BASEADA NO CÓDIGO DO MUNICÍPIO
SELECT
OCO.numero_ocorrencia, -- Seleciona o número da ocorrência
ENV.natureza_ocorrencia_codigo, -- Seleciona o código da natureza do envolvido na ocorrência
ENV.envolvimento_descricao_longa, -- Seleciona a descrição da natureza do envolvido na ocorrência
ENV.ind_pessoa_situacao_rua, -- Indica se é uma pessoa em situação de rua
OCO.complemento_natureza_codigo, -- Seleciona o código do complemento da natureza da ocorrência
OCO.complemento_natureza_descricao_longa, -- Seleciona a descrição do complemento da natureza da ocorrência
...
-- ORDENAÇÃO DOS RESULTADOS POR UNIDADE E NATUREZA DO FATO
ORDER BY RPM_2025, UEOP_2025, ENV.natureza_ocorrencia_codigo;
