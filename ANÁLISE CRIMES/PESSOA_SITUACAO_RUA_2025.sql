...
WHERE OCO.data_hora_fato >= '2025-03-01'
      AND OCO.data_hora_fato < '2025-03-31'
AND (
    ENV.ind_pessoa_situacao_rua = 'S' -- BUSCA INDIVIDUO EM SITUACAO DE RUA, com as respostas possíveis nessa coluna sendo 'S' (sim), 'N' (nao) e 'D' (nao informado)
...
ORDER BY RPM_2024, UEOP_2024, ENV.natureza_ocorrencia_codigo;
