...
OCO.natureza_consumado, -- Indica se a natureza foi tentada ou consumada
OCO.natureza_secundaria1_descricao,  -- Seleciona descrição da primeira natureza secundária
OCO.natureza_secundaria1_consumado , -- Indica se a primeira natureza secundária foi tentada ou consumada
OCO.natureza_secundaria2_descricao,  --Seleciona descrição da segunda natureza secundária
OCO.natureza_secundaria2_consumado, -- Indica se a segunda natureza secundária foi tentada ou consumada
OCO.natureza_secundaria3_descricao,  --- Seleciona descrição da terceira natureza secundária
OCO.natureza_secundaria3_consumado, -- Indica se a terceira natureza secundária foi tentada ou consumada
...
AND OCO.ind_estado ='F' -- Filtra ocorrências com estado Fechado
AND YEAR(data_hora_fato) = :ANO  -- PROMPT PARA FILTRAR ANO DO FATO
