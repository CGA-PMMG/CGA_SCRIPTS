/*--------------------------------------------------------------------------------------------------------------------------------------------
 **********************************************Manutenção de Rede de Proteção Preventiva (MRPP)***********************************************

 * O indicador tem por objetivo aferir a participação da PMMG em reuniões de manutenção de Redes de Proteção Preventiva, com a finalidade 
 * de orientar os cidadãos quanto à adoção de medidas de autoproteção, identificar e buscar soluções para problemas de segurança pública, 
