 ...
 * registradas pela PM  e PC, classificando o 
...
(
    SELECT 
        ...
        OCO.unidade_area_militar_nome, -- Seleciona o nome da área militar
         CAST(OCO.codigo_municipio AS INTEGER) codigo_municipio, -- Seleciona o código do município da ocorrência 
...
SELECT  
    ...
    RVD.RPM_2025,  -- Seleciona a RPM
    RVD.UEOP_2025, -- Seleciona a UEOP
    RVD.setor_codigo,  -- Seleciona o código do setor
    RVD.situacao_zona,  -- Seleciona a situação da zona
    RVD.tipo_descricao,  -- Seleciona a descrição do local
    RVD.udi, -- Seleciona a UDI
    RVD.ueop, -- Seleciona a UEOP
    RVD.cia, -- Seleciona a CIA
    RVD.setor_PM -- Seleciona o setor PM
