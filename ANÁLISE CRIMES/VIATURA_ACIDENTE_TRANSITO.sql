/* ----------------------------------------------------------------------------------------------------------------------------------------------------=
 *  =========================================================== ACIDENTE DE VIATURAS  ==================================================================
 * 
 * Este script realiza uma pesquisa de placas de viaturas (atribuidas da CTE PLACAS)  que sofreram acidentes de trânsito. A busca retorna 
 * e retornar dados do veículo envolvido, da ocorrência e do(s) envolvido(s) relacionado(s).
 *-----------------------------------------------------------------------------------------------------------------------------------------------------*/
WITH 
-- Insira na CTE de Placa a relação dos número das placas que deseja buscar
PLACA AS 
(
SELECT  'QMV1595' AS placa UNION
SELECT  'QXW0F57' AS placa UNION
SELECT  'QMV1525' AS placa UNION
SELECT  'QXW0E58' AS placa UNION
SELECT  'OQM9216' AS placa UNION
SELECT  'RMR6H32' AS placa UNION
SELECT  'QMV0669' AS placa UNION
SELECT  'QXW0I67' AS placa UNION
SELECT  'QXW3B38' AS placa UNION
SELECT  'QXW2J57' AS placa UNION
SELECT  'RTU1E40' AS placa UNION
SELECT  'QXW0G59' AS placa UNION
SELECT  'RTU1E80' AS placa UNION
SELECT  'RTU1F07' AS placa UNION
SELECT  'RMR6H29' AS placa UNION
SELECT  'PUE9022' AS placa UNION
SELECT  'QXW2J28' AS placa UNION
SELECT  'PUE7210' AS placa UNION
SELECT  'RMX4J90' AS placa UNION
SELECT  'QXW1C58' AS placa UNION
SELECT  'QMV1741' AS placa UNION
SELECT  'QXW2H55' AS placa UNION
SELECT  'PUE9299' AS placa UNION
SELECT  'QXW0D10' AS placa UNION
SELECT  'PUE8014' AS placa UNION
SELECT  'RUL1F55' AS placa UNION
SELECT  'OQM9079' AS placa UNION
SELECT  'QXW3E86' AS placa UNION
SELECT  'PUE8493' AS placa UNION
SELECT  'QMV4116' AS placa UNION
SELECT  'QMV4118' AS placa UNION
SELECT  'QMV0671' AS placa UNION
SELECT  'RTD9H22' AS placa UNION
SELECT  'QXW2G65' AS placa UNION
SELECT  'QXW2J51' AS placa UNION
SELECT  'OQM9079' AS placa UNION
SELECT  'OQM9079' AS placa UNION
SELECT  'PUE9032' AS placa UNION
SELECT  'PUE9723' AS placa UNION
SELECT  'PUE9745' AS placa UNION
SELECT  'RUL5F01' AS placa UNION
SELECT  'RTU5E78' AS placa UNION
SELECT  'QXW0I63' AS placa UNION
SELECT  'QXW0D28' AS placa UNION
SELECT  'PUE9028' AS placa UNION
SELECT  'PUE9746' AS placa UNION
SELECT  'QMV1I68' AS placa UNION
SELECT  'PUE9032' AS placa UNION
SELECT  'PUE9745' AS placa UNION
SELECT  'PUE9723' AS placa UNION
SELECT  'QMV4118' AS placa UNION
SELECT  'QMV4116' AS placa UNION
SELECT  'PUE9067' AS placa UNION
SELECT  'QMV1549' AS placa UNION
SELECT  'QXW0B96' AS placa UNION
SELECT  'QXW0B96' AS placa UNION
SELECT  'RTC0D85' AS placa UNION
SELECT  'QXW1B70' AS placa UNION
SELECT  'QMV1549' AS placa UNION
SELECT  'QMV1114' AS placa UNION
SELECT  'QMV1608' AS placa UNION
SELECT  'RTC0D50' AS placa UNION
SELECT  'QXW2J59' AS placa UNION
SELECT  'RTF8J54' AS placa UNION
SELECT  'QXW2H94' AS placa UNION
SELECT  'QXW0D70' AS placa UNION
SELECT  'QXW2J76' AS placa UNION
SELECT  'QXW1H41' AS placa UNION
SELECT  'QMV0736' AS placa UNION
SELECT  'QXW3A86' AS placa UNION
SELECT  'PUE8978' AS placa UNION
SELECT  'QMV1530' AS placa UNION
SELECT  'QXW0F40' AS placa 
),

-------------------- NÃO ALTERE A CTE DE AGUAS --------------------------
AGUAS AS (
...
VEIC.numero_veiculo, -- Número do veículo
VEIC.numero_placa, -- Número da placa do veículo
VEIC.numero_chassis, -- Número do chassi do veículo
VEIC.situacao_placa_codigo, -- Código da situação da placa do veículo
VEIC.situacao_placa_descricao, -- Descrição da situação da placa do veículo
VEIC.ano_fabricacao, -- Ano de fabricação do veículo
VEIC.ano_modelo,  -- Ano do modelo do veículo
VEIC.marca_modelo_descricao, -- Descrição da marca/modelo do veículo
VEIC.cor_veiculo_descricao, -- Descrição da cor do veículo
VEIC.tipo_veiculo_descricao, -- Descrição do tipo do veículo
VEIC.categoria_veiculo_descricao, -- Descrição da categoria do veículo
VEIC.especie_veiculo_descricao, -- Descrição da éspecie do veículo
...
FROM PLACA
INNER JOIN db_bisp_reds_reporting.tb_veiculo_ocorrencia VEIC ON PLACA.placa = VEIC.numero_placa
INNER JOIN db_bisp_reds_reporting.tb_ocorrencia OCO ON VEIC.numero_ocorrencia = OCO.numero_ocorrencia
LEFT JOIN db_bisp_reds_reporting.tb_envolvido_ocorrencia ENV ON VEIC.numero_ocorrencia = ENV.numero_ocorrencia AND VEIC.NUMERO_ENVOLVIDO = ENV.numero_envolvido
...
WHERE 1 = 1 
AND VEIC.situacao_placa_codigo = '9800' -- Filtra veículos com a situação da placa como Acidentado
AND OCO.natureza_codigo IN ('T00008', 'T00009')        -- Filtra por ocorrência  de natureza T00008 - ACIDENTE DE TRÂNSITO SEM VÍTIMA e T00009 - ACIDENTE DE TRÂNSITO COM VÍTIMA
...
AND OCO.data_hora_fato BETWEEN '2023-01-01 00:00:00.000' AND '2025-09-25 23:59:59.000' -- Delimitação temporal das ocorrências
