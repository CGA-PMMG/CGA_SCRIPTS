CASE WHEN OCO.codigo_municipio IN (310690,311590,311960,312130,312738,312850,314020,314950,315010,315540,315620,316290) THEN '02 BPM'
		...
		WHEN OCO.codigo_municipio IN (310210,310290,310330,310560,310680,311630,312150,312500,312940,314570,314660,315030,315870,315940,316070) THEN '09 BPM'
		...
		WHEN OCO.codigo_municipio IN (312235,310270,310100,310340,311950,313400,314630,317160,311700,313330,314140,315217,314870) THEN '70 BPM'
		...
		WHEN OCO.codigo_municipio IN (316620,315440,310163,310640,311220,311310,311320,311490,311540,311800,311830,312040,312140,312390,313390,313540,313790,314230,314590,315080,315230,315310,315380,315520,315910,316090,316600) THEN '31 BPM'
		...
		WHEN OCO.codigo_municipio IN (310170,310520,312245,312560,313470,313580,313600,313650,314055,314315,314675,315510,315660,315710,315810,316030) THEN '44 BPM'
