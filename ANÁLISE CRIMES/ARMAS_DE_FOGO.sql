 ...
 * --------------------------------------------------------------------------------------------------------------------------*/
SELECT OCO.numero_ocorrencia,  -- NÚMERO DA OCORRÊNCIA POLICIAL
...
INNER JOIN db_bisp_reds_reporting.tb_arma_ocorrencia AFO ON  ENV.numero_ocorrencia = AFO.numero_ocorrencia AND ENV.numero_envolvido = AFO.numero_envolvido  
