 ...
 *  ================================================================================================================================================
 * 
 * O Indicador tem por finalidade avaliar a eficiência na resposta rápida das PPVD em relação aos registros dos boletins de ocorrência de Primeira Resposta. 
 *---------------------------------------------------------------------------------------------------------------------------------------------------------*/
WITH 
...
Registro AS (
    SELECT 
        ...
        OCO.data_hora_fato AS data_registro,             -- Data/hora do primeiro registro
    ...
    WHERE 
           (                                           
            OCO.natureza_codigo     = 'U33004' OR      
            OCO.natureza_secundaria1_codigo = 'U33004' OR
            OCO.natureza_secundaria2_codigo = 'U33004' OR
            OCO.natureza_secundaria3_codigo = 'U33004'
            )-- Inclusão por natureza principal
        AND YEAR(OCO.data_hora_fato) >= 2021            -- Data do fato a partir de 2021
...
ORDER BY 
    I.ano_atendimento, 
    I.mes_atendimento, 
    I.nome_completo_envolvido;                      -- Ordena cronologicamente e alfabeticamente
