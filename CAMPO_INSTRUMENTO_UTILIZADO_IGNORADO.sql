...
SELECT
    ...
    SUM(CASE 
        WHEN OCO.instrumento_utilizado_codigo IS NULL OR OCO.instrumento_utilizado_codigo = '9800' -- VERIFICA A AUSÊNCIA OU CÓDIGO ESPECÍFICO DE INSTRUMENTO UTILIZADO
        THEN 1 ELSE 0 
