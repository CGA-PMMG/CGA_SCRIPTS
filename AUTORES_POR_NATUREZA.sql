...
WHERE YEAR(OCO.data_hora_fato) BETWEEN 2023 AND 2024 -- OCORRÊNCIAS ENTRE OS ANOS DE 2023 E 2024
    ...
    AND OCO.natureza_codigo IN('X01155','X01156','X01157') -- CÓDIGOS ESPECÍFICOS DE NATUREZA DA OCORRÊNCIA (ROUBO/FURTO DE BICICLETAS)
    AND ENV.envolvimento_codigo IN ('0100', '0200') -- CÓDIGO DE ENVOLVIMENTO (AUTORES DO CRIME)
