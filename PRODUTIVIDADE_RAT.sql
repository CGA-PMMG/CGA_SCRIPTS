 ...
 * níveis hierárquicos (RPM, BPM, Companhia, e Pelotão).
 -----------------------------------------------------------------------------------------------------------------*/
SELECT        
                PROD.numero_ocorrencia AS 'RAT.NUM_ATIVIDADE', -- SELECIONA O NUMERO DO RAT (OCORRENCIA-RAT)
                PROD.indicador_descricao AS DESCRICAO, -- SELECIONA A DESCRICAO DO INDICADOR
