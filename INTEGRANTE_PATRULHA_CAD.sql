 ...
 * de relatórios da Polícia Militar. O foco é obter dados para chamadas atendidas por unidades específicas da PM, 
 * em enfâse, os militares associados ao recurso e o tempo gasto na chamada.  
 ---------------------------------------------------------------------------------------------------------------*/
...
SELECT 
    ...
    tb_recurso_componente.pessoa_id,                        -- ID DA PESSOA ASSOCIADA AO RECURSO
    tb_recurso_componente.pessoa_nome,                      -- NOME DA PESSOA ASSOCIADA AO RECURSO
...
LEFT JOIN 
    db_bisp_cad_reporting.tb_recurso_componente AS tb_recurso_componente ON tb_empenho.recurso_id = tb_recurso_componente.recurso_id 
